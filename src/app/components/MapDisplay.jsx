...
const busStops = [
  ...
  // 瀬田駅は正常
  { name: '瀬田駅バス停', lat: 34.986612, lng: 135.925536 },
  ...
  // 瀬田駅口は正常
  { name: '瀬田駅口バス停', lat: 34.984592, lng: 135.926760 },
  ...
  // 一里山バス停は正常
  { name: '一里山バス停', lat: 34.983073, lng: 135.928844 },
  // 月の輪バス停は正常
  { name: '月の輪バス停', lat: 34.988328, lng: 135.932292 },
  ...
  // 月の輪二丁目バス停は正常
  { name: '月の輪二丁目バス停', lat: 34.987540, lng: 135.933700 },
  ...
  // 一ツ松バス停は正常
  { name: '一ツ松バス停', lat: 34.980979, lng: 135.930666 },
  ...
  // 一里山三丁目バス停は正常
  { name: '一里山三丁目バス停', lat: 34.983404, lng: 135.935473 },
  ...
  // 朝倉バス停は正常
  { name: '朝倉バス停', lat: 34.977965, lng: 135.933572 },
  { name: '雄琴温泉ホテル前バス停', lat: 35.109, lng: 135.8897 },
  { name: '石山幼稚園前バス停', lat: 34.9575, lng: 135.8918 },

  { name: 'バイパス一里山バス停', lat: 34.982482, lng: 135.937375 },
  ...
  // 月の輪三丁目バス停は正常
  { name: '月の輪三丁目バス停', lat: 34.982010, lng: 135.940443 },
  ...
  // 龍谷大学バス停は正常
  { name: '龍谷大学バス停', lat: 34.964799, lng: 135.941725 },
